...
#ifndef PLATFORM_LINK7_V2
#error Mismatch between the configured platform and the actual platform. Expected LINK7_V2 to be defined
#endif
...
// #define BUTTON2_PIN PIN(1, 8) //DO NOT USE
#define BUTTON1_PIN PIN(1, 15)

#define INTERRUPT_TEST_PIN PIN(0, 10)

#define BATTERY_VOLTAGE_PIN PIN(0,5)
#define BATTERY_VOLTAGE_ADC_CHANNEL ADC_CHANNEL_5
...
#define SX127x_DIO0_PIN PIN(1, 4) //interrupt
#define SX127x_DIO1_PIN PIN(1, 1) //interrupt
