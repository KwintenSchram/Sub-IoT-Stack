...
#ifndef PLATFORM_MARSUR_V1
#error Mismatch between the configured platform and the actual platform. Expected LINK7_V1 to be defined
#endif
...
#define WATER_DETECT_PIN PIN(0, 12)
#define WATER_OUTPUT_PIN PIN(0, 11)

#define CHARGING_STATE_PIN PIN(1,7)
#define HALL_EFFECT_PIN PIN(0,5)
