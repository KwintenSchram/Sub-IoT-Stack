...
#define BUTTON1_PIN PIN(0, 3)
#define BUTTON2_PIN PIN(1, 7)
#define BUTTON3_PIN PIN(1, 15)

#define PIR_OUT_PIN PIN(1, 14)
#define PIR_IN_PIN PIN(1, 12)
#define PIR_SUPPLY_PIN PIN(1, 13)

#define HAL_EFFECT_PIN PIN(0, 2)
#define HAL_EFFECT_SUPPLY_PIN PIN(1, 2) //TODO remove

#define ACCELEROMETER_INT_PIN PIN(0, 6)

#define BATTERY_VOLTAGE_PIN PIN(0,4)
