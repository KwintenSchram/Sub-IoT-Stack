...
static device_state_config_file_t device_state_config_file_cached
    = (device_state_config_file_t) { .interval = 5 * 60, .led_flash_state = true, .enabled = true, .tx_power = LOW_TX_POWER };
...
bool device_state_flash_is_led_enabled() { return device_state_config_file_cached.led_flash_state; }
